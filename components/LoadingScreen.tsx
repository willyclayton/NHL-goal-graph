...
export default function LoadingScreen({ error }: LoadingScreenProps) {
  if (error) {
    return (
      <div className="fixed inset-0 flex flex-col items-center justify-center bg-[#0b1620] z-50">
  ...
  return (
    <div className="fixed inset-0 flex flex-col items-center justify-center bg-[#0b1620] z-50">
      <div className="relative w-12 h-12 mb-6">
        ...
        <div className="absolute inset-0 rounded-full border-2 border-t-sky-600 border-r-transparent border-b-transparent border-l-amber-400 animate-spin" />
      </div>
